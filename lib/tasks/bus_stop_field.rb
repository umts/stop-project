  ...
  task create: :environment do
    fields = {
      ...
      'Sign' => [
        ...
        { name: 'Mounting', column: :mounting, field_type: :choice, choices: ['PVTA pole', 'Utility pole', 'City pole', 'Structure', 'No sign'], description: 'Determine the mounting that a sign is on.' },
      ...
      'Shelter' => [
        { name: 'Shelter', column: :shelter, field_type: :choice, choices: ['No shelter', 'PVTA shelter', 'Other shelter', 'Nearby building'], description: 'Determine if the bus stop has a shelter or not.' },
      ...
      'Amenity' => [
        { name: 'Bench', column: :bench, field_type: :choice, choices: ['PVTA bench', 'Other structure', 'Other bench', 'PVTA and other bench', 'None'], description: 'Determine if the bus stop has a bench or area to sit.' },
      ...
      'Accessible' => [
        ...
        { name: 'ADA landing pad', column: :ada_landing_pad, field_type: :boolean, description: "Is there a concrete/brick/asphalt area that is unobstructed and a minimum of 5'x8'?" },
